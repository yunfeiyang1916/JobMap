...
namespace Job.Model.Entity
{
    ...
    public partial class Company : Entity<Company>
    {
        ...
        //    entity.Industry = "abc";
        //    entity.Label = "abc";
        //    entity.RecruitUrl = "abc";
        //    entity.Url = "abc";
        //    entity.Address = "abc";
        //    entity.Lng = 0;
        //    entity.Lat = 0;
        //    entity.MinSalary = "abc";
        //    entity.MinPositionName = "abc";
        //    entity.MaxSalary = "abc";
        //    entity.MaxPositionName = "abc";
        ...
        public static Company FindByID(Int32 id)
        {
            if (Meta.Count >= 1000)
                return Find(_.ID, id);
            else // 实体缓存
        ...
        /// <returns>实体集</returns>
        public static EntityList<Company> Search(Int32 userid, DateTime start, DateTime end, String key, PageParameter param)
        {
